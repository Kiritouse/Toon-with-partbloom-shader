...
public class PartBloom : MonoBehaviour
{
    ...
    void OnRenderImage(RenderTexture source, RenderTexture destination)
    {
        if (_Material)
        {
            ...
            _Material.SetVector("_bloomColor", bloomColor);//bloom的颜色
            _Material.SetFloat("_bloomFactor", bloomFactor);//bloom的权重
